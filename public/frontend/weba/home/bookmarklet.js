...
whi.AlertHtml.prototype.alertData = {
    ...
    weHeartIt: '<div class="whi-title">' + whi.i18n.t('https://weheartit.com/bookmarklet.hey') + '</div><div class="whi-content">' + whi.i18n.t('bookmarklet.alert_we_heart_it') + " <a href='http://help.weheartit.com/customer/portal/articles/59356-hearting-images-on-whi' target='_blank'><br><br>" + whi.i18n.t('bookmarklet.need_help_q') + "</div>",
    private: '<div class="whi-title">' + whi.i18n.t('https://weheartit.com/bookmarklet.hey') + '</div><div class="whi-content">' + whi.i18n.t('bookmarklet.alert_private') + " <a href='http://help.weheartit.com/customer/portal/articles/59360-hearting-from-private-pages' target='_blank'><br><br>" + whi.i18n.t('bookmarklet.need_help_q') + "</a></div>",
    ...
    noImages: '<div class="whi-title">' + whi.i18n.t('https://weheartit.com/bookmarklet.hey') + '</div><div class="whi-content">' + whi.i18n.t('bookmarklet.no_image_we_can_heart') + " <a href='http://help.weheartit.com/customer/portal/articles/59402-invalid-images' target='_blank'>" + whi.i18n.t('bookmarklet.why_is_that_q') + "</a></div>",
